...
proc create_root_design { parentCell } {
  ...
  # Create instance: moments_0, and set properties
  set moments_0 [ create_bd_cell -type ip -vlnv ts:hls:resize_accel:1.0 moments_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins moments_0/s_axi_AXILiteS]
  ...
  connect_bd_intf_net -intf_net axis_dwidth_converter_0_M_AXIS [get_bd_intf_pins axis_dwidth_converter_0/M_AXIS] [get_bd_intf_pins moments_0/src]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs moments_0/s_axi_AXILiteS/Reg] SEG_moments_0_Reg
