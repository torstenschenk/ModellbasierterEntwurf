...
HD_PWD='C:/Users/Misca/beuth_ws1920/ModellbasierterEntwurf/PYNQ-ts/boards/Pynq-Z1/resizer/bitstream/resizer/resizer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log resizer_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source resizer_wrapper.tcl -notrace
