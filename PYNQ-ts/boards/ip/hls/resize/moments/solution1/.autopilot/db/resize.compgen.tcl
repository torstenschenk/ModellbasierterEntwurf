...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_src_data_V_dout { I 24 vector } p_src_data_V_empty_n { I 1 bit } p_src_data_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dst_data_V_din { O 24 vector } p_dst_data_V_full_n { I 1 bit } p_dst_data_V_write { O 1 bit } } \
} "
}
