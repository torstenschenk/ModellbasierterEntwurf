...
// ==============================================================
#ifndef __resize_accel_mac_hbi__HH__
#define __resize_accel_mac_hbi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(resize_accel_mac_hbi) {
    ...
    SC_CTOR(resize_accel_mac_hbi):  simcore_mac_2_U ("simcore_mac_2_U") {
