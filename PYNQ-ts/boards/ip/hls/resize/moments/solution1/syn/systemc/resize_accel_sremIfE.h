...
// ==============================================================
#ifndef __resize_accel_sremIfE__HH__
#define __resize_accel_sremIfE__HH__
#include "ACMP_srem.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(resize_accel_sremIfE) {
    ...
    SC_CTOR(resize_accel_sremIfE):  ACMP_srem_U ("ACMP_srem_U") {
        ACMP_srem_U.clk(clk);
