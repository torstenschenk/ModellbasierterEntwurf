...
\begin{figure}[H]
\centering
\subfloat{\includegraphics[width=\textwidth]{img_pynq/Moment_PS5}}
\caption{Moment Rechner in PS 5}
\label{fig:Moment Rechner_in_PS_5}
\end{figure}

\begin{figure}[H]
\centering
\subfloat{\includegraphics[width=\textwidth]{img_pynq/Moment_PS6}}
\caption{Moment Rechner in PS 6}
\label{fig:Moment Rechner_in_PS_6}
\end{figure}


\begin{figure}[H]
\centering
\subfloat{\includegraphics[width=\textwidth]{img_pynq/Moment_PS7}}
...
\bibitem{Zynq Design} 
Zynq, and Zynq MPSoC, IP Core ,u.s.w,
\\\texttt{Buch: Exploring Zynq MPSoC With PYNQ and Machine Learning Applications}
