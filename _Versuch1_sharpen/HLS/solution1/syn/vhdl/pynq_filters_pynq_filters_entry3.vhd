...
entity pynq_filters_pynq_filters_entry3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of pynq_filters_pynq_filters_entry3 is 
...
begin
    ...
    ap_sig_38_assign_proc : process(ap_start, ap_done_reg, reduce_out_full_n)
    begin
                ap_sig_38 <= ((reduce_out_full_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    reduce_out_din <= reduce;

    reduce_out_write_assign_proc : process(ap_sig_cseq_ST_st1_fsm_0, ap_sig_38)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not(ap_sig_38))) then 
