...
set id 107
set name pynq_filters_dadd_64ns_64ns_64_5_full_dsp
...
set id 108
set name pynq_filters_dmul_64ns_64ns_64_6_max_dsp
...
set id 109
set name pynq_filters_sitodp_32s_64_6
...
eval "cg_default_interface_gen_dc { \
    id 110 \
    name src_data_stream_V_V \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_src_data_stream_V_V \
    op interface \
    ports { src_data_stream_V_V_dout { I 10 vector } src_data_stream_V_V_empty_n { I 1 bit } src_data_stream_V_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dst_data_stream_V_V_din { O 10 vector } dst_data_stream_V_V_full_n { I 1 bit } dst_data_stream_V_V_write { O 1 bit } } \
} "
}
