...
L_row: for(int row = 0; row < IMG_H; row++) {
#pragma HLS LOOP_TRIPCOUNT min=240 max=480

L_col: for(int col = 0; col < IMG_W; col++) {
...
#pragma HLS dataflow
	...
	RGB_IMAGE input_image_8U3(IMG_H, IMG_W);
	RGB_IMAGE output_image_8U3(IMG_H, IMG_W);
	RGB_IMAGE input_image_8U3_copy1(IMG_H, IMG_W);
	RGB_IMAGE input_image_8U3_copy2(IMG_H, IMG_W);
	GRAY_IMAGE image_blur(IMG_H, IMG_W);
	GRAY_IMAGE input_image_8U1(IMG_H, IMG_W);
	GRAY10_IMAGE image_blur_10S1(IMG_H, IMG_W);
	GRAY10_IMAGE image_laplacian_10S1(IMG_H, IMG_W);
	GRAY10_IMAGE image_laplacian_reduced_10S1(IMG_H, IMG_W);
	RGB10_IMAGE image_laplacian_10S3(IMG_H, IMG_W);
	RGB10_IMAGE input_image_10S3(IMG_H, IMG_W);
	RGB10_IMAGE ouput_image_10S3(IMG_H, IMG_W);
