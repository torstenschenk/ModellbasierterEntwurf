...
; <label>:2                                       ; preds = %1
  ...
  %tmp_7 = call i32 (...)* @_ssdm_op_SpecRegionBegin([17 x i8]* @p_str) nounwind
...
; <label>:5                                       ; preds = %4, %3
  ...
  %tmp_5 = zext i5 %i to i64
  %c_addr = getelementptr [11 x i32]* %c, i64 0, i64 %tmp_5
  %c_load = load i32* %c_addr, align 4
  %tmp_6 = mul nsw i32 %data1, %c_load
  %acc_1 = add nsw i32 %acc, %tmp_6
  %empty_2 = call i32 (...)* @_ssdm_op_SpecRegionEnd([17 x i8]* @p_str, i32 %tmp_7) nounwind
  %i_1 = add i5 %i, -1
  br label %1
