...
architecture behav of fir is 
    ...
    "fir,hls_ip_2016_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.520000,HLS_SYN_LAT=89,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=180,HLS_SYN_LUT=159}";
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and (tmp_1_reg_189 = ap_const_lv1_0))) then 
    ...
    begin
                ap_sig_104 <= (ap_const_lv1_1 = ap_CS_fsm(8 downto 8));
    end process;
    ...
    ap_sig_cseq_ST_st9_fsm_8_assign_proc : process(ap_sig_104)
    begin
        if (ap_sig_104) then 
    ...
    shift_reg_we0_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, tmp_1_fu_143_p2, tmp_1_reg_189, tmp_fu_135_p3, ap_sig_cseq_ST_st3_fsm_2)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and (tmp_1_reg_189 = ap_const_lv1_0)) or ((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (tmp_fu_135_p3 = ap_const_lv1_0) and not((tmp_1_fu_143_p2 = ap_const_lv1_0))))) then 
