...
(* CORE_GENERATION_INFO="fir,hls_ip_2016_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.520000,HLS_SYN_LAT=89,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=180,HLS_SYN_LUT=159}" *)
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st3_fsm_2) & (tmp_1_reg_189 == 1'b0))) begin
        data1_reg_114 <= shift_reg_q0;
    end else if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (tmp_fu_135_p3 == 1'b0) & ~(tmp_1_fu_143_p2 == 1'b0))) begin
        data1_reg_114 <= x;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (tmp_fu_135_p3 == 1'b0))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_sig_cseq_ST_st3_fsm_2) & (tmp_1_reg_189 == 1'b0)) | ((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (tmp_fu_135_p3 == 1'b0) & ~(tmp_1_fu_143_p2 == 1'b0)))) begin
        shift_reg_we0 = 1'b1;
    end else begin
        shift_reg_we0 = 1'b0;
    end
