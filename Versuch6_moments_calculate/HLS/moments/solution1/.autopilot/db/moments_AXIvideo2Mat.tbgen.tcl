set moduleName moments_AXIvideo2Mat
...
set isOneStateSeq 0
set C_modelName {moments_AXIvideo2Mat}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_data_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "AXI_video_strm_V_data_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : [], "CDFG" : "moments_AXIvideo2Mat", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2077923", "Max" : "2077923"}
	, {"Name" : "Interval", "Min" : "2077923", "Max" : "2077923"}
]}

set Spec2ImplPortList { 
	AXI_video_strm_V_data_V { axis {  { in_data_TDATA in_data 0 24 }  { in_data_TVALID in_vld 0 1 } } }
	...
	AXI_video_strm_V_dest_V { axis {  { in_data_TREADY in_acc 1 1 }  { in_data_TDEST in_data 0 1 } } }
