...
set id 10
set name moments_udiv_42ns_21ns_42_46_seq
...
set id 13
set name moments_udiv_32ns_21ns_32_36_seq
set corename simcore_udiv_seq
set op udiv
set stage_num 36
set max_latency -1
...
set id 15
set name moments_mul_21ns_21ns_42_3
...
set id 18
set name moments_mul_43ns_43ns_86_11
set corename simcore_mul
set op mul
set stage_num 11
set max_latency -1
...
set id 19
set name moments_mac_muladd_11ns_11ns_42ns_42_1
...
set out_width 42
set exp i0*i1+i2
set arg_lists {i0 {11 0 +} i1 {11 0 +} m {22 0 +} i2 {42 0 +} p {42 0 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
...
set id 20
set name moments_mul_mul_11ns_11ns_22_1
set corename simcore_mul
set op mul
set stage_num 1
set max_latency -1
...
set out_width 22
set exp i0*i1
set arg_lists {i0 {11 0 +} i1 {11 0 +} p {22 0 +} }
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
    id ${id} \
