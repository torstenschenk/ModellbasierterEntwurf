...
#ifndef __moments_udiv_42ns_21ns_42_46_seq__HH__
#define __moments_udiv_42ns_21ns_42_46_seq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(moments_udiv_42ns_21ns_42_46_seq) {
    ...
    ACMP_udiv_seq<ID, 46, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_udiv_seq_U;

    SC_CTOR(moments_udiv_42ns_21ns_42_46_seq):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
