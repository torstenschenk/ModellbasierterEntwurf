...
const sc_lv<9> fir::ap_ST_st1_fsm_0 = "1";
const sc_lv<9> fir::ap_ST_st2_fsm_1 = "10";
const sc_lv<9> fir::ap_ST_st3_fsm_2 = "100";
const sc_lv<9> fir::ap_ST_st4_fsm_3 = "1000";
const sc_lv<9> fir::ap_ST_st5_fsm_4 = "10000";
const sc_lv<9> fir::ap_ST_st6_fsm_5 = "100000";
const sc_lv<9> fir::ap_ST_st7_fsm_6 = "1000000";
const sc_lv<9> fir::ap_ST_st8_fsm_7 = "10000000";
const sc_lv<9> fir::ap_ST_st9_fsm_8 = "100000000";
...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    fir_mul_32s_32s_32_6_U0->din0(c_q0);
    fir_mul_32s_32s_32_6_U0->din1(data1_reg_114);
    fir_mul_32s_32s_32_6_U0->ce(ap_var_for_const0);
    ...
    SC_METHOD(thread_acc_1_fu_168_p2);
    ...
    sc_trace(mVcdFile, acc_1_fu_168_p2, "acc_1_fu_168_p2");
...
void fir::thread_ap_clk_no_reset_() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st9_fsm_8.read())) {
        acc_reg_89 = acc_1_fu_168_p2.read();
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st9_fsm_8.read())) {
        i_reg_102 = i_1_reg_208.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read()) && 
                !esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0))) {
        i_reg_102 = ap_const_lv5_A;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st3_fsm_2.read())) {
        i_1_reg_208 = grp_fu_124_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read())) {
        i_cast_reg_180 = i_cast_fu_131_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read()) && esl_seteq<1,1,1>(tmp_fu_135_p3.read(), ap_const_lv1_0))) {
        tmp_1_reg_189 = tmp_1_fu_143_p2.read();
    }
}

void fir::thread_acc_1_fu_168_p2() {
    acc_1_fu_168_p2 = (!grp_fu_162_p2.read().is_01() || !acc_reg_89.read().is_01())? sc_lv<32>(): (sc_biguint<32>(grp_fu_162_p2.read()) + sc_biguint<32>(acc_reg_89.read()));
}
...
void fir::thread_ap_sig_104() {
    ap_sig_104 = esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm.read().range(8, 8));
}

void fir::thread_ap_sig_24() {
    ap_sig_24 = esl_seteq<1,1,1>(ap_CS_fsm.read().range(0, 0), ap_const_lv1_1);
}

void fir::thread_ap_sig_62() {
    ap_sig_62 = esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm.read().range(1, 1));
}

void fir::thread_ap_sig_81() {
    ap_sig_81 = esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm.read().range(2, 2));
}

void fir::thread_ap_sig_95() {
    ap_sig_95 = esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm.read().range(3, 3));
}
...
void fir::thread_tmp_4_fu_154_p1() {
    tmp_4_fu_154_p1 = esl_zext<64,32>(i_cast_reg_180.read());
}

void fir::thread_tmp_5_fu_158_p1() {
    tmp_5_fu_158_p1 = esl_zext<64,32>(i_cast_reg_180.read());
}
