set C_TypeInfoList {{ 
"fir" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"result": [[], {"array": ["0", [20]]}] }, {"n": [[],"0"] }],[],""], 
...
set C_modelArgList {
	{ result int 32 regular {array 20 { 2 2 } 1 1 }  }
	{ n int 32 unused  }
}
set C_modelArgMapList {[ 
	{ "Name" : "result", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "result","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 19,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ result_address0 sc_out sc_lv 5 signal 0 } 
	...
	{ result_address1 sc_out sc_lv 5 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "result_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "result", "role": "address0" }} , 
 	...
 	{ "name": "result_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "result", "role": "address1" }} , 
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : [], "CDFG" : "fir", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		{"Name" : "result", "Type" : "Memory", "Direction" : "IO", "BlockSignal" : [], "SubConnect" : []}, 
...
set Spec2ImplPortList { 
	result { ap_memory {  { result_address0 mem_address 1 5 }  { result_ce0 mem_ce 1 1 }  { result_we0 mem_we 1 1 }  { result_d0 mem_din 1 32 }  { result_q0 mem_dout 0 32 }  { result_address1 mem_address 1 5 }  { result_ce1 mem_ce 1 1 }  { result_we1 mem_we 1 1 }  { result_d1 mem_din 1 32 }  { result_q1 mem_dout 0 32 } } }
