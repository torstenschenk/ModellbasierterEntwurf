...
HD_PWD='C:/Users/Misca/beuth_ws1920/ModellbasierterEntwurf/PYNQ-ts/boards/Pynq-Z1/resizer/bitstream/resizer/resizer.runs/resizer_resize_accel_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log resizer_resize_accel_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source resizer_resize_accel_0_0.tcl
