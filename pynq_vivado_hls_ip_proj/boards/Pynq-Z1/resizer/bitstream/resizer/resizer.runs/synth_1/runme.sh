...
HD_PWD='C:/Users/Misca/beuth_ws1920/ModellbasierterEntwurf/PYNQ-ts/boards/Pynq-Z1/resizer/bitstream/resizer/resizer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log resizer_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source resizer_wrapper.tcl
