set moduleName resize_Loop_2_proc61
...
set C_modelName {resize_Loop_2_proc61}
set C_modelType { void 0 }
set C_modelArgList {
	{ out_image_V_V int 24 regular {fifo 0 volatile }  }
	{ p_dst_data_V int 24 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "out_image_V_V", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ out_image_V_V_dout sc_in sc_lv 24 signal 0 } 
	{ out_image_V_V_empty_n sc_in sc_logic 1 signal 0 } 
	{ out_image_V_V_read sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_image_V_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "out_image_V_V", "role": "dout" }} , 
 	{ "name": "out_image_V_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_image_V_V", "role": "empty_n" }} , 
 	{ "name": "out_image_V_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_image_V_V", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "out_image_V_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	out_image_V_V { ap_fifo {  { out_image_V_V_dout fifo_data 0 24 }  { out_image_V_V_empty_n fifo_status 0 1 }  { out_image_V_V_read fifo_update 1 1 } } }
