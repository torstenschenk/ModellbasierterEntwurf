...
set C_modelArgList {
	{ p_dst_data_V int 24 regular {fifo 0 volatile }  }
	{ dst_data_V int 24 regular {axi_s 1 volatile  { dst Data } }  }
	{ dst_last_V int 1 regular {axi_s 1 volatile  { dst Last } }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p_dst_data_V", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ p_dst_data_V_dout sc_in sc_lv 24 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_dst_data_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "p_dst_data_V", "role": "dout" }} , 
 	...
 	{ "name": "dst_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "dst_data_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "p_dst_data_V", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "58321", "Max" : "58321"}
	, {"Name" : "Interval", "Min" : "58321", "Max" : "58321"}
]}
...
set Spec2ImplPortList { 
	p_dst_data_V { ap_fifo {  { p_dst_data_V_dout fifo_data 0 24 }  { p_dst_data_V_empty_n fifo_status 0 1 }  { p_dst_data_V_read fifo_update 1 1 } } }
	dst_data_V { axis {  { dst_TDATA out_data 1 24 }  { dst_TREADY out_acc 0 1 } } }
	dst_last_V { axis {  { dst_TVALID out_vld 1 1 }  { dst_TLAST out_data 1 1 } } }
}
