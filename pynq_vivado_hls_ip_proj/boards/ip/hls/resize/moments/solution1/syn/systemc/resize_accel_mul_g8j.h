...
// ==============================================================
#ifndef __resize_accel_mul_g8j__HH__
#define __resize_accel_mul_g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(resize_accel_mul_g8j) {
    ...
    SC_CTOR(resize_accel_mul_g8j):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
