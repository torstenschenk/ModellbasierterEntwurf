...
module split_ip_AXIvideo2Mat103 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [7:0] direction;
output  [7:0] direction_out_din;
input   direction_out_full_n;
output   direction_out_write;
...
wire   [0:0] exitcond1_i_i_fu_332_p2;
...
reg   [0:0] exitcond1_i_i_reg_414;
reg    img_data_stream_1_V_blk_n;
reg    img_data_stream_2_V_blk_n;
reg    direction_out_blk_n;
reg   [10:0] p_5_i_i_reg_184;
...
wire   [0:0] exitcond9_i_i_fu_320_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & ~(1'b0 == exitcond9_i_i_fu_320_p2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_368) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_378)) & ~(exitcond1_i_i_fu_332_p2 == 1'b0))) begin
            ap_reg_ppiten_pp1_it0 <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & (1'b0 == exitcond9_i_i_fu_320_p2))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_sig_cseq_ST_pp2_stg0_fsm_5) & ~((1'b1 == ap_reg_ppiten_pp2_it0) & ap_sig_385) & ~(1'b0 == eol_2_i_i_phi_fu_257_p4))) begin
            ap_reg_ppiten_pp2_it0 <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_368) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_378)) & ~(1'b0 == exitcond1_i_i_reg_414))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & (1'b0 == exitcond1_i_i_reg_414) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_368) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_378)))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_368) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_378)) & ~(1'b0 == exitcond1_i_i_reg_414))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it0) & (exitcond1_i_i_fu_332_p2 == 1'b0) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_368) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_378)))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (exitcond1_i_i_fu_332_p2 == 1'b0) & ~(((1'b1 == ap_reg_ppiten_pp1_it0) & ap_sig_368) | ((1'b1 == ap_reg_ppiten_pp1_it1) & ap_sig_378)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & ~(1'b0 == exitcond9_i_i_fu_320_p2)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st4_fsm_3) & ~(1'b0 == exitcond9_i_i_fu_320_p2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~((ap_start == 1'b0) | (ap_done_reg == 1'b1)))) begin
        ...
        direction_out_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~ap_sig_477)) begin
        direction_out_write = 1'b1;
    end else begin
        direction_out_write = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & (1'b0 == exitcond1_i_i_reg_414))) begin
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) | ((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it0) & (exitcond1_i_i_fu_332_p2 == 1'b0) & (1'b0 == brmerge_i_i_fu_347_p2)) | ((1'b1 == ap_sig_cseq_ST_pp2_stg0_fsm_5) & (1'b1 == ap_reg_ppiten_pp2_it0) & (1'b0 == eol_2_i_i_phi_fu_257_p4)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_st4_fsm_3 : begin
            if (~(1'b0 == exitcond9_i_i_fu_320_p2)) begin
                ap_NS_fsm = ap_ST_st1_fsm_0;
            end else begin
...
always @ (*) begin
    ap_sig_324 = ((1'b1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (1'b1 == ap_reg_ppiten_pp1_it1) & (1'b0 == exitcond1_i_i_reg_414));
end

always @ (*) begin
    ap_sig_368 = ((exitcond1_i_i_fu_332_p2 == 1'b0) & (1'b0 == brmerge_i_i_fu_347_p2) & (AXI_video_strm_V_data_V_0_vld_out == 1'b0));
end

always @ (*) begin
    ap_sig_378 = (((1'b0 == exitcond1_i_i_reg_414) & (img_data_stream_0_V_full_n == 1'b0)) | ((1'b0 == exitcond1_i_i_reg_414) & (img_data_stream_1_V_full_n == 1'b0)) | ((1'b0 == exitcond1_i_i_reg_414) & (img_data_stream_2_V_full_n == 1'b0)));
end
...
always @ (*) begin
    ap_sig_477 = ((ap_start == 1'b0) | (ap_done_reg == 1'b1) | (direction_out_full_n == 1'b0));
end

assign brmerge_i_i_fu_347_p2 = (sof_1_i_i_fu_96 | eol_i_i_phi_fu_199_p4);

assign direction_out_din = direction;

assign exitcond1_i_i_fu_332_p2 = ((p_5_i_i_reg_184 == ap_const_lv11_780) ? 1'b1 : 1'b0);

assign exitcond9_i_i_fu_320_p2 = ((p_i_i_reg_173 == ap_const_lv11_438) ? 1'b1 : 1'b0);
...
assign j_V_fu_338_p2 = (p_5_i_i_reg_184 + ap_const_lv11_1);

assign tmp_user_V_fu_307_p1 = AXI_video_strm_V_user_V_0_data_out;

endmodule //split_ip_AXIvideo2Mat103
