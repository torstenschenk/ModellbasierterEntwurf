...
set id 20
set name split_ip_mux_3to1_sel2_8_1
...
set id 38
set name split_ip_mac_muladd_4ns_8ns_8ns_10_1
...
set out_width 10
set exp i0*i1+i2
set arg_lists {i0 {4 0 +} i1 {8 0 +} m {10 0 +} i2 {8 0 +} p {10 0 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
...
set id 39
set name split_ip_mac_muladd_2s_8ns_10s_11_1
set corename simcore_mac
set op mac
set stage_num 1
set max_latency -1
...
set out_width 11
set exp i0*i1+i2
set arg_lists {i0 {2 1 +} i1 {8 0 +} m {10 1 +} i2 {10 1 +} p {11 1 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
    id ${id} \
...
set id 43
set name split_ip_mac_muladd_3s_8ns_10s_11_1
set corename simcore_mac
set op mac
set stage_num 1
set max_latency -1
...
set out_width 11
set exp i0*i1+i2
set arg_lists {i0 {3 1 +} i1 {8 0 +} m {11 1 +} i2 {10 1 +} p {11 1 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
    id ${id} \
...
set id 46
set name split_ip_mac_muladd_2s_8ns_9s_10_1
set corename simcore_mac
set op mac
set stage_num 1
set max_latency -1
...
set out_width 10
set exp i0*i1+i2
set arg_lists {i0 {2 1 +} i1 {8 0 +} m {10 1 +} i2 {9 1 +} p {10 1 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
    id ${id} \
...
set id 48
set name split_ip_mac_muladd_3ns_8ns_11s_11_1
set corename simcore_mac
set op mac
set stage_num 1
set max_latency -1
...
set out_width 11
set exp i0*i1+i2
set arg_lists {i0 {3 0 +} i1 {8 0 +} m {11 0 +} i2 {11 1 +} p {11 1 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
    id ${id} \
...
set ID 53
set MemName split_ip_Filter2D_k_buf_0_val_3
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_kernel_val_1_V_0_read { I 2 vector } } \
} "
}
