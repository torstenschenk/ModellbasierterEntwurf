set moduleName split_ip_RGB2Gray
...
set isOneStateSeq 0
set C_modelName {split_ip_RGB2Gray}
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"], "CDFG" : "split_ip_RGB2Gray", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		...
		"WaitState" : [],
		"SubBlockPort" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.split_ip_mac_muladd_8ns_6ns_16ns_16_1_U12", "Parent" : "0", "Child" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.split_ip_mac_muladd_8ns_8ns_16ns_16_1_U13", "Parent" : "0", "Child" : []}]}

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2080081", "Max" : "2080081"}
	, {"Name" : "Interval", "Min" : "2080081", "Max" : "2080081"}
]}
