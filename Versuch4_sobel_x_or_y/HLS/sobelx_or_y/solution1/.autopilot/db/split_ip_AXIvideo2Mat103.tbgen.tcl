set moduleName split_ip_AXIvideo2Mat103
...
set isOneStateSeq 0
set C_modelName {split_ip_AXIvideo2Mat103}
...
set C_modelArgList {
	...
	{ direction int 8 regular  }
	{ direction_out int 8 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "AXI_video_strm_V_data_V", "interface" : "axis", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "direction", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "direction_out", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ direction sc_in sc_lv 8 signal 10 } 
	{ direction_out_din sc_out sc_lv 8 signal 11 } 
	{ direction_out_full_n sc_in sc_logic 1 signal 11 } 
	{ direction_out_write sc_out sc_logic 1 signal 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "direction", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "direction", "role": "default" }} , 
 	{ "name": "direction_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "direction_out", "role": "din" }} , 
 	{ "name": "direction_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "direction_out", "role": "full_n" }} , 
 	{ "name": "direction_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "direction_out", "role": "write" }}  ]}

set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : [], "CDFG" : "split_ip_AXIvideo2Mat103", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2080083", "Max" : "2080083"}
	, {"Name" : "Interval", "Min" : "2080083", "Max" : "2080083"}
]}
...
set Spec2ImplPortList { 
	...
	direction { ap_none {  { direction in_data 0 8 } } }
	direction_out { ap_fifo {  { direction_out_din fifo_data 1 8 }  { direction_out_full_n fifo_status 0 1 }  { direction_out_write fifo_update 1 1 } } }
}
