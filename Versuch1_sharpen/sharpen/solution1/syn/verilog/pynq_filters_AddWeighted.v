...
module pynq_filters_AddWeighted (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_sig_20;
wire    grp_pynq_filters_arithm_pro_1_fu_32_ap_start;
wire    grp_pynq_filters_arithm_pro_1_fu_32_ap_done;
wire    grp_pynq_filters_arithm_pro_1_fu_32_ap_idle;
wire    grp_pynq_filters_arithm_pro_1_fu_32_ap_ready;
wire    grp_pynq_filters_arithm_pro_1_fu_32_src1_data_stream_0_V_V_read;
wire    grp_pynq_filters_arithm_pro_1_fu_32_src1_data_stream_1_V_V_read;
wire    grp_pynq_filters_arithm_pro_1_fu_32_src1_data_stream_2_V_V_read;
wire    grp_pynq_filters_arithm_pro_1_fu_32_src2_data_stream_0_V_V_read;
wire    grp_pynq_filters_arithm_pro_1_fu_32_src2_data_stream_1_V_V_read;
wire    grp_pynq_filters_arithm_pro_1_fu_32_src2_data_stream_2_V_V_read;
wire   [9:0] grp_pynq_filters_arithm_pro_1_fu_32_dst_data_stream_0_V_V_din;
wire    grp_pynq_filters_arithm_pro_1_fu_32_dst_data_stream_0_V_V_write;
wire   [9:0] grp_pynq_filters_arithm_pro_1_fu_32_dst_data_stream_1_V_V_din;
wire    grp_pynq_filters_arithm_pro_1_fu_32_dst_data_stream_1_V_V_write;
wire   [9:0] grp_pynq_filters_arithm_pro_1_fu_32_dst_data_stream_2_V_V_din;
wire    grp_pynq_filters_arithm_pro_1_fu_32_dst_data_stream_2_V_V_write;
reg    ap_reg_grp_pynq_filters_arithm_pro_1_fu_32_ap_start;
reg    ap_sig_101;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 2'b1;
#0 ap_reg_grp_pynq_filters_arithm_pro_1_fu_32_ap_start = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(1'b0 == grp_pynq_filters_arithm_pro_1_fu_32_ap_done))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_reg_grp_pynq_filters_arithm_pro_1_fu_32_ap_start <= 1'b0;
    end else begin
        if (((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~ap_sig_101)) begin
            ap_reg_grp_pynq_filters_arithm_pro_1_fu_32_ap_start <= 1'b1;
        end else if ((1'b1 == grp_pynq_filters_arithm_pro_1_fu_32_ap_ready)) begin
            ap_reg_grp_pynq_filters_arithm_pro_1_fu_32_ap_start <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(1'b0 == grp_pynq_filters_arithm_pro_1_fu_32_ap_done)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~(1'b0 == grp_pynq_filters_arithm_pro_1_fu_32_ap_done))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_st2_fsm_1 : begin
            if (~(1'b0 == grp_pynq_filters_arithm_pro_1_fu_32_ap_done)) begin
                ap_NS_fsm = ap_ST_st1_fsm_0;
            end else begin
                ap_NS_fsm = ap_ST_st2_fsm_1;
            end
...
assign dst_data_stream_0_V_V_din = grp_pynq_filters_arithm_pro_1_fu_32_dst_data_stream_0_V_V_din;

assign dst_data_stream_1_V_V_din = grp_pynq_filters_arithm_pro_1_fu_32_dst_data_stream_1_V_V_din;

assign dst_data_stream_2_V_V_din = grp_pynq_filters_arithm_pro_1_fu_32_dst_data_stream_2_V_V_din;

assign grp_pynq_filters_arithm_pro_1_fu_32_ap_start = ap_reg_grp_pynq_filters_arithm_pro_1_fu_32_ap_start;

endmodule //pynq_filters_AddWeighted
