...
#ifndef FIFO_pynq_filters_input_image_8U3_copy2_data_str_2_HH_
#define FIFO_pynq_filters_input_image_8U3_copy2_data_str_2_HH_

#include <systemc>
using namespace std;
SC_MODULE(FIFO_pynq_filters_input_image_8U3_copy2_data_str_2) {
    static const unsigned int DATA_WIDTH = 8;
    static const unsigned int ADDR_WIDTH = 15;
    static const unsigned int FIFO_pynq_filters_input_image_8U3_copy2_data_str_2_depth = 19201;
    ...
    sc_core::sc_signal< sc_dt::sc_lv<DATA_WIDTH> >  mStorage[FIFO_pynq_filters_input_image_8U3_copy2_data_str_2_depth];
    ...
    SC_CTOR(FIFO_pynq_filters_input_image_8U3_copy2_data_str_2) : mTrace(0) {
        ...
        SC_METHOD(proc_dout);
        sensitive << mOutPtr;
        for (unsigned i = 0; i < FIFO_pynq_filters_input_image_8U3_copy2_data_str_2_depth; i++) {
    ...
    ~FIFO_pynq_filters_input_image_8U3_copy2_data_str_2() {
        ...
        if (reset.read() == sc_dt::SC_LOGIC_1) {
            ...
            if (if_read_ce.read() == sc_dt::SC_LOGIC_1
               ...
               && internal_empty_n.read() == sc_dt::SC_LOGIC_1) {
                ...
                if (mOutPtr.read().to_uint() == (FIFO_pynq_filters_input_image_8U3_copy2_data_str_2_depth-1)) {
                    ptr = 0;
                ...
                assert(ptr.to_uint() < FIFO_pynq_filters_input_image_8U3_copy2_data_str_2_depth);
                mOutPtr.write(ptr);
            }
            if (if_write_ce.read() == sc_dt::SC_LOGIC_1
                ...
                if (ptr.to_uint() == (FIFO_pynq_filters_input_image_8U3_copy2_data_str_2_depth-1)) {
                    ptr = 0;
                    mFlag_nEF_hint.write(~mFlag_nEF_hint.read());
                } else {
                    ptr++;
    ...
    void proc_dout() {
        ...
        if (ptr.to_uint() > FIFO_pynq_filters_input_image_8U3_copy2_data_str_2_depth) {
...
#endif //FIFO_pynq_filters_input_image_8U3_copy2_data_str_2_HH_
