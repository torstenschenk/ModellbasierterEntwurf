...
set id 102
set name pynq_filters_ddiv_64ns_64ns_64_31
...
set id 103
set name pynq_filters_sitodp_32ns_64_6
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_reduce \
    op interface \
    ports { reduce_dout { I 32 vector } reduce_empty_n { I 1 bit } reduce_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_tmp_1_out_out \
    op interface \
    ports { tmp_1_out_out_din { O 64 vector } tmp_1_out_out_full_n { I 1 bit } tmp_1_out_out_write { O 1 bit } } \
} "
}
