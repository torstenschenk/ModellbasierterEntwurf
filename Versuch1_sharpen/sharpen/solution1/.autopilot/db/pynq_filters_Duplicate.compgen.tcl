...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { src_rows_V_dout { I 10 vector } src_rows_V_empty_n { I 1 bit } src_rows_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { src_cols_V_dout { I 11 vector } src_cols_V_empty_n { I 1 bit } src_cols_V_read { O 1 bit } } \
} "
}
