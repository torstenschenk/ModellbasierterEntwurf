...
entity moments_control_s_axi is
generic (
...
architecture behave of moments_control_s_axi is
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_X_CTRL =>
                        rdata_data <= (0 => int_x_ap_vld, others => '0');
                    when ADDR_Y_DATA_0 =>
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (x_ap_vld = '1') then
                    int_x <= UNSIGNED(x); -- clear on read
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (angle_ap_vld = '1') then
                    int_angle <= UNSIGNED(angle); -- clear on read
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (angle_ap_vld = '1') then
                    int_angle_ap_vld <= '1';
                elsif (ar_hs = '1' and raddr = ADDR_ANGLE_CTRL) then
                    int_angle_ap_vld <= '0'; -- clear on read
                end if;
            end if;
        end if;
    end process;
