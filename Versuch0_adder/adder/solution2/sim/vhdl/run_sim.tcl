...
if {[file isfile add_function.autotvin.dat]} {
	file delete -force add_function.autotvin.dat
}

if {[file isfile add_function.autotvout.dat]} {
	file delete -force add_function.autotvout.dat
}
