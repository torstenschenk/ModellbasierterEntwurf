...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "add_function.autotvin.dat"
	set constFileTvOut       "add_function.autotvout.dat"
	set constFileHdlTvIn     "add_function.autohdltvin.dat"
	set constFileHdlTvOut    "add_function.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
